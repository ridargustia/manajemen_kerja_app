...
class Surat_rekomendasi extends CI_Controller
{
    ...
    function index()
    {
        ...
        if (is_masteradmin()) {
            $this->data['get_all'] = $this->Surat_rekomendasi_model->get_all_by_numbering();
    ...
    function create()
    {
        ...
        $this->data['action']     = 'admin/surat_rekomendasi/create_action';
        ...
        $this->load->view('back/surat_rekomendasi/surat_rekomendasi_add', $this->data);
    }
    ...
    function create_action()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            redirect('admin/surat_rekomendasi/create');
        } else {
    ...
    function numbering($id_surat_rekomendasi)
    {
        //TODO Inisialisasi variabel
        $this->data['page_title'] = 'Penomoran ' . $this->data['module'];
        $this->data['action']     = 'admin/surat_rekomendasi/numbering_action';
        ...
        //TODO Get detail surat_rekomendasi by id
        $this->data['data_surat_rekomendasi'] = $this->Surat_rekomendasi_model->get_by_id($id_surat_rekomendasi);

        $this->data['status'] = $this->Status_model->get_by_id($this->data['data_surat_rekomendasi']->status_id);
        $this->data['agama'] = $this->Agama_model->get_by_id($this->data['data_surat_rekomendasi']->agama_id);
        $this->data['pekerjaan'] = $this->Pekerjaan_model->get_by_id($this->data['data_surat_rekomendasi']->pekerjaan_id);

        //TODO Load view dengan mengirim data
        $this->load->view('back/surat_rekomendasi/surat_rekomendasi_numbering', $this->data);
    }
    ...
    function numbering_action()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            //TODO Kondisi validasi gagal, redirect ke halaman create
            redirect('admin/surat_rekomendasi/numbering/' . $this->input->post('id_surat_rekomendasi'));
        } else {
            //TODO Simpan data ke array
            $data = array(
