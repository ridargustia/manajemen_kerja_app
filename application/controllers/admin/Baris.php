...
class Baris extends CI_Controller
{
  ...
  function create_action()
  {
    ...
    if (is_grandadmin()) {
      ...
      $this->data['check_by_name']  = $this->Baris_model->check_by_name_and_instansi_and_cabang($this->input->post('baris_name'), $instansi_id, $cabang_id);
    } elseif (is_masteradmin()) {
  ...
  {
    $this->data['baris'] = $this->Baris_model->get_baris_by_cabang_combobox($this->uri->segment(4));
