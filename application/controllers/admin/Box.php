...
class Box extends CI_Controller
{
  ...
  function create_action()
  {
    ...
    if (is_grandadmin()) {
      ...
      $this->data['check_by_name']  = $this->Box_model->check_by_name_and_instansi_and_cabang($this->input->post('box_name'), $instansi_id, $cabang_id);
    } elseif (is_masteradmin()) {
  ...
  function pilih_box()
  {
    $this->data['box'] = $this->Box_model->get_box_by_cabang_combobox($this->uri->segment(4));
