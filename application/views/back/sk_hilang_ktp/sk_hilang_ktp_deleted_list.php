                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($get_all as $data) {
                                    ...
                                    $restore = '<a href="' . base_url('admin/sk_hilang_ktp/restore/' . $data->id_sk_hilang_ktp) . '" class="btn btn-primary" title="Restore Data"><i class="fa fa-refresh"></i></a>';
                                    $delete = '<a href="' . base_url('admin/sk_hilang_ktp/delete_permanent/' . $data->id_sk_hilang_ktp) . '" id="delete-button-permanent" class="btn btn-danger" title="Hapus Permanen"><i class="fa fa-trash"></i></a>';
                                ?>
                                    <tr>
