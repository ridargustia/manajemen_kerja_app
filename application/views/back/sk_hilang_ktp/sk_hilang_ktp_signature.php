        ...
        <script>
            ...
            saveButton.addEventListener("click", function(event) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    window.location = "<?php echo base_url(); ?>admin/sk_hilang_ktp/signature/" + $('#id_sk_hilang_ktp').val();
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/sk_hilang_ktp/signature_action",
                        data: {
                            image: newImage2,
                            id_sk_hilang_ktp: $('#id_sk_hilang_ktp').val()
                        },
                        success: function(datas1) {
                            signaturePad.clear();

                            window.location = "<?php echo base_url(); ?>admin/sk_hilang_ktp/numbering/" + $('#id_sk_hilang_ktp').val();
                        }
                    });
                }
            });
