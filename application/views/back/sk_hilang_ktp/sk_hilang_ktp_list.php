                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($get_all as $data) {
                                    ...
                                    $detail = '<a href="' . base_url('admin/sk_hilang_ktp/numbering/' . $data->id_sk_hilang_ktp) . '" class="btn btn-success" title="Tindak Lanjut"><i class="fa fa-send"></i></a>';
                                    $edit = '<a href="' . base_url('admin/sk_hilang_ktp/update/' . $data->id_sk_hilang_ktp) . '" class="btn btn-warning" title="Edit Data"><i class="fa fa-pencil"></i></a>';
                                    $delete = '<a href="' . base_url('admin/sk_hilang_ktp/delete/' . $data->id_sk_hilang_ktp) . '" id="delete-button" class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i></a>';
                                ?>
                                    <tr>
