        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                            <?php if (empty($data_sk_hilang_ktp->signature_image)) { ?>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <?php
                                            if ($data_sk_hilang_ktp->no_surat === NULL) {
                                            ...
                                            ?>
                                                ...
                                                <?php echo form_input($id_sk_hilang_ktp, $data_sk_hilang_ktp->id_sk_hilang_ktp) ?>
                                                <button type="submit" class="btn btn-success"><i class="fa fa-send"></i> Kirim</button>
                                            <?php
                                                echo form_close();
                                            } else {
                                                echo $data_sk_hilang_ktp->no_surat;
                                            }
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Nama</td>
                                        <td style="width:10px">:</td>
                                        <td class="text-left"><?php echo $data_sk_hilang_ktp->name ?></td>
                                    </tr>
                                    <tr>
                                        <td>NIK</td>
                                        <td>:</td>
                                        <td class="text-left"><?php echo $data_sk_hilang_ktp->nik ?></td>
                                    </tr>
                                    <tr>
                                        <td style="width:120px">Tempat Lahir</td>
                                        <td>:</td>
                                        <td class="text-left"><?php echo $data_sk_hilang_ktp->birthplace ?></td>
                                    </tr>
                                    <tr>
                                        <td>Tanggal Lahir</td>
                                        <td>:</td>
                                        <td class="text-left"><?php echo $data_sk_hilang_ktp->birthdate ?></td>
                                    </tr>
                                    <tr>
                                        <td style="width:120px">No HP/Telepon</td>
                                        <td>:</td>
                                        <td class="text-left">+<?php echo $data_sk_hilang_ktp->phone ?></td>
                                    </tr>
                                    <tr>
                                        <td>Jenis Kelamin</td>
                                        <td>:</td>
                                        <td class="text-left">
                                            <?php
                                            if ($data_sk_hilang_ktp->gender === '1') {
                                                $gender = 'Laki-laki';
                                            } elseif ($data_sk_hilang_ktp->gender === '2') {
                                                $gender = 'Perempuan';
                                            }
                                            echo $gender;
                                            ?>
                                    ...
                                    <tr>
                                        <td>Alamat</td>
                                        <td>:</td>
                                        <td class="text-left"><?php echo $data_sk_hilang_ktp->address ?></td>
                                    </tr>
                                    <tr>
                                        <td>Tempat Kehilangan</td>
                                        <td>:</td>
                                        <td class="text-left"><?php echo $data_sk_hilang_ktp->tempat_kehilangan ?></td>
                                    </tr>
                                    <tr>
                                        <td>Tanggal Kehilangan</td>
                                        <td>:</td>
                                        <td class="text-left"><?php echo $data_sk_hilang_ktp->tgl_kehilangan ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <?php if ($data_sk_hilang_ktp->no_surat != NULL) { ?>
                    <div class="box-footer">
                        <div class="pull-right">
                            <a href="<?php echo base_url('admin/sk_hilang_ktp/preview_document/' . $data_sk_hilang_ktp->id_sk_hilang_ktp) ?>" class="btn btn-primary" title="Preview Document" target="_blank"><i class="fa fa-file-text-o"></i> Pratinjau Dokumen</a>
