        ...
        <script>
            ...
            saveButton.addEventListener("click", function(event) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    window.location = "<?php echo base_url(); ?>admin/sk_jalan/signature/" + $('#id_sk_jalan').val();
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/sk_jalan/signature_action",
                        data: {
                            image: newImage2,
                            id_sk_jalan: $('#id_sk_jalan').val()
                        },
                        success: function(datas1) {
                            signaturePad.clear();

                            window.location = "<?php echo base_url(); ?>admin/sk_jalan/numbering/" + $('#id_sk_jalan').val();
                        }
                    });
                }
            });
