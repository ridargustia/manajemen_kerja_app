                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($get_all as $data) {
                                    ...
                                    $detail = '<a href="' . base_url('admin/sk_jalan/update/' . $data->id_sk_jalan) . '" class="btn btn-primary" title="Detail Data"><i class="fa fa-eye"></i></a>';
                                    $delete = '<a href="' . base_url('admin/sk_jalan/delete/' . $data->id_sk_jalan) . '" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i></a>';
                                ?>
                                    <tr>
