        ...
        <script>
            ...
            saveButton.addEventListener("click", function(event) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    window.location = "<?php echo base_url(); ?>admin/sk_domisili/signature/" + $('#id_sk_domisili').val();
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/sk_domisili/signature_action",
                        data: {
                            image: newImage2,
                            id_sk_domisili: $('#id_sk_domisili').val()
                        },
                        success: function(datas1) {
                            signaturePad.clear();

                            window.location = "<?php echo base_url(); ?>admin/sk_domisili/numbering/" + $('#id_sk_domisili').val();
                        }
                    });
                }
            });
