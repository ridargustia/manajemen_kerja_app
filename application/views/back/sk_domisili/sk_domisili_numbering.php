                ...
                <?php if ($data_sk_domisili->no_surat != NULL) { ?>
                    <div class="box-footer">
                        <div class="pull-right">
                            ...
                            <?php } elseif (is_superadmin() and $data_sk_domisili->token != NULL) { ?>
                                <a href="https://web.whatsapp.com/send?phone=<?php echo $data_sk_domisili->phone ?>&text=Assalamu'alaikum,%0aKami dari Kantor Desa Saobi, menyampaikan informasi bahwa surat permohonan anda sudah selesai diproses, silahkan klik link berikut <?php echo base_url('sk_domisili/auth_download') ?> untuk download surat tersebut. Dengan memasukkan token berikut *<?php echo $data_sk_domisili->token ?>*, jangan memberikan token ini ke orang lain. Terima kasih" class="btn btn-success" title="Teruskan Pemohon" target="_blank"><i class="fa fa-share"></i> Teruskan Pemohon</a>
                            <?php } ?>
                        </div>
                    </div>
                <?php } ?>
