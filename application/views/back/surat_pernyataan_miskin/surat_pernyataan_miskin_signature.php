        ...
        <script>
            ...
            saveButton.addEventListener("click", function(event) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    window.location = "<?php echo base_url(); ?>admin/surat_pernyataan_miskin/signature/" + $('#id_surat_pernyataan_miskin').val();
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/surat_pernyataan_miskin/signature_action",
                        data: {
                            image: newImage2,
                            id_surat_pernyataan_miskin: $('#id_surat_pernyataan_miskin').val()
                        },
                        success: function(datas1) {
                            signaturePad.clear();

                            window.location = "<?php echo base_url(); ?>admin/surat_pernyataan_miskin/numbering/" + $('#id_surat_pernyataan_miskin').val();
                        }
                    });
                }
            });
