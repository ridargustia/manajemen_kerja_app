        ...
        <script>
            ...
            saveButton.addEventListener("click", function(event) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    window.location = "<?php echo base_url(); ?>admin/sk_pindah/signature/" + $('#id_sk_pindah').val();
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/sk_pindah/signature_action",
                        data: {
                            image: newImage2,
                            id_sk_pindah: $('#id_sk_pindah').val()
                        },
                        success: function(datas1) {
                            signaturePad.clear();

                            window.location = "<?php echo base_url(); ?>admin/sk_pindah/numbering/" + $('#id_sk_pindah').val();
                        }
                    });
                }
            });
