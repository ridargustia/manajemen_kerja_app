                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($get_all as $data) {
                                    ...
                                    $detail = '<a href="' . base_url('admin/sk_meninggal_dunia/numbering/' . $data->id_sk_meninggal_dunia) . '" class="btn btn-success" title="Tindak Lanjut"><i class="fa fa-send"></i></a>';
                                    $edit = '<a href="' . base_url('admin/sk_meninggal_dunia/update/' . $data->id_sk_meninggal_dunia) . '" class="btn btn-warning" title="Edit Data"><i class="fa fa-pencil"></i></a>';
