        ...
        <script>
            ...
            saveButton.addEventListener("click", function(event) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    window.location = "<?php echo base_url(); ?>admin/sk_meninggal_dunia/signature/" + $('#id_sk_meninggal_dunia').val();
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/sk_meninggal_dunia/signature_action",
                        data: {
                            image: newImage2,
                            id_sk_meninggal_dunia: $('#id_sk_meninggal_dunia').val()
                        },
                        success: function(datas1) {
                            signaturePad.clear();

                            window.location = "<?php echo base_url(); ?>admin/sk_meninggal_dunia/numbering/" + $('#id_sk_meninggal_dunia').val();
                        }
                    });
                }
            });
