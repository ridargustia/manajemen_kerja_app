                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($get_all as $data) {
                                    ...
                                    $detail = '<a href="' . base_url('admin/surat_rekomendasi/numbering/' . $data->id_surat_rekomendasi) . '" class="btn btn-success" title="Tindak Lanjut"><i class="fa fa-send"></i></a>';
                                    $edit = '<a href="' . base_url('admin/surat_rekomendasi/update/' . $data->id_surat_rekomendasi) . '" class="btn btn-warning" title="Edit Data"><i class="fa fa-pencil"></i></a>';
                                    $delete = '<a href="' . base_url('admin/surat_rekomendasi/delete/' . $data->id_surat_rekomendasi) . '" id="delete-button" class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i></a>';
                                ?>
                                    <tr>
