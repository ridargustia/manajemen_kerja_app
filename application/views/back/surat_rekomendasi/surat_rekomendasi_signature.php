        ...
        <script>
            ...
            saveButton.addEventListener("click", function(event) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    window.location = "<?php echo base_url(); ?>admin/surat_rekomendasi/signature/" + $('#id_surat_rekomendasi').val();
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/surat_rekomendasi/signature_action",
                        data: {
                            image: newImage2,
                            id_surat_rekomendasi: $('#id_surat_rekomendasi').val()
                        },
                        success: function(datas1) {
                            signaturePad.clear();

                            window.location = "<?php echo base_url(); ?>admin/surat_rekomendasi/numbering/" + $('#id_surat_rekomendasi').val();
                        }
                    });
                }
            });
