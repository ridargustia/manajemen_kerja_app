    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="form-group"><label>No. HP/Telepon</label>
          ...
          <div class="form-group"><label>Foto Profil Saat Ini</label>
          ...
          <div class="form-group"><label>Ganti Foto Profil</label>
      ...
      <div class="box box-success">
        ...
        <div class="box-body">
          ...
          <div class="form-group"><label>Hak Akses Saat Ini</label>
            <p>
              <?php
