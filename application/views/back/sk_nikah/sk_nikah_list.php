                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($get_all as $data) {
                                    ...
                                    $detail = '<a href="' . base_url('admin/sk_nikah/numbering/' . $data->id_sk_nikah) . '" class="btn btn-success" title="Tindak Lanjut"><i class="fa fa-send"></i></a>';
                                    $edit = '<a href="' . base_url('admin/sk_nikah/update/' . $data->id_sk_nikah) . '" class="btn btn-warning" title="Edit Data"><i class="fa fa-pencil"></i></a>';
                                    $delete = '<a href="' . base_url('admin/sk_nikah/delete/' . $data->id_sk_nikah) . '" id="delete-button" class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i></a>';
                                ?>
                                    <tr>
                                        <td style="text-align: center"><?php echo $no++ ?></td>
                                        <td style="text-align: center"><?php echo $data->suami_name ?></td>
                                        <td style="text-align: center"><?php echo $data->istri_name ?></td>
