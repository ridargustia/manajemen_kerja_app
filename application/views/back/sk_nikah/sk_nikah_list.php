                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($get_all as $data) {
                                    ...
                                    $detail = '<a href="' . base_url('admin/sk_nikah/update/' . $data->id_sk_nikah) . '" class="btn btn-primary" title="Detail Data"><i class="fa fa-eye"></i></a>';
                                    $delete = '<a href="' . base_url('admin/sk_nikah/delete/' . $data->id_sk_nikah) . '" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i></a>';
                                ?>
                                    <tr>
