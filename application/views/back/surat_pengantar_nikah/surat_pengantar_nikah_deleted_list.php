                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($get_all as $data) {
                                    ...
                                    $restore = '<a href="' . base_url('admin/surat_pengantar_nikah/restore/' . $data->id_surat_pengantar_nikah) . '" class="btn btn-primary" title="Restore Data"><i class="fa fa-refresh"></i></a>';
                                    $delete = '<a href="' . base_url('admin/surat_pengantar_nikah/delete_permanent/' . $data->id_surat_pengantar_nikah) . '" id="delete-button-permanent" class="btn btn-danger" title="Hapus Permanen"><i class="fa fa-trash"></i></a>';
                                ?>
                                    <tr>
