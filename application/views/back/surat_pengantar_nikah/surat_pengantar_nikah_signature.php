        ...
        <script>
            ...
            saveButton.addEventListener("click", function(event) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    window.location = "<?php echo base_url(); ?>admin/surat_pengantar_nikah/signature/" + $('#id_surat_pengantar_nikah').val();
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/surat_pengantar_nikah/signature_action",
                        data: {
                            image: newImage2,
                            id_surat_pengantar_nikah: $('#id_surat_pengantar_nikah').val()
                        },
                        success: function(datas1) {
                            signaturePad.clear();

                            window.location = "<?php echo base_url(); ?>admin/surat_pengantar_nikah/numbering/" + $('#id_surat_pengantar_nikah').val();
                        }
                    });
                }
            });
