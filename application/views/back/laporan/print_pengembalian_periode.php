...
$pdf->SetTitle('LAPORAN PENGEMBALIAN PERIODE '.date_only($this->input->post('tgl_awal')).' - '.date_only($this->input->post('tgl_akhir')).' ');
...
<h3 align="center">
  LAPORAN PENGEMBALIAN PERIODE <br>
...
<table cellpadding="1" border="1">
  <thead>
    <tr>
      ...
      <td style="width: 30%; text-align: center; font-weight: bold">Dikembalikan Pada</td>
...
';
  ...
  foreach($get_all_periode as $data)
  {
    ...
    <tr>
      ...
      <td style="width: 30%; text-align: center;">'.date_only($data->tgl_kembali).'</td>
...
$pdf->Output('LAPORAN_PENGEMBALIAN_PERIODE '.date_only($this->input->post('tgl_awal')).' - '.date_only($this->input->post('tgl_akhir')).'.pdf', 'I');
