            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $no = 1; foreach($get_all as $menu_access){
                  // action
                  $edit = '<a href="'.base_url('admin/menuaccess/update/'.$menu_access->id_menu_access).'" class="btn btn-warning"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="'.base_url('admin/menuaccess/delete/'.$menu_access->id_menu_access).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>
