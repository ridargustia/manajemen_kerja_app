        ...
        <script>
            ...
            saveButton.addEventListener("click", function(event) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    window.location = "<?php echo base_url(); ?>admin/sk_usaha/signature/" + $('#id_sk_usaha').val();
                } else {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>admin/sk_usaha/signature_action",
                        data: {
                            image: newImage2,
                            id_sk_usaha: $('#id_sk_usaha').val()
                        },
                        success: function(datas1) {
                            signaturePad.clear();

                            window.location = "<?php echo base_url(); ?>admin/sk_usaha/numbering/" + $('#id_sk_usaha').val();
                        }
                    });
                }
            });
