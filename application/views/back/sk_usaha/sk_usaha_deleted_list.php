                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($get_all as $data) {
                                    ...
                                    $restore = '<a href="' . base_url('admin/sk_usaha/restore/' . $data->id_sk_usaha) . '" class="btn btn-primary" title="Restore Data"><i class="fa fa-refresh"></i></a>';
                                    $delete = '<a href="' . base_url('admin/sk_usaha/delete_permanent/' . $data->id_sk_usaha) . '" id="delete-button-permanent" class="btn btn-danger" title="Hapus Permanen"><i class="fa fa-trash"></i></a>';
                                ?>
                                    <tr>
