    ...
    <div class="wrapper">
                        ...
                        <div class="col-lg-12">
                            <div class="box box-primary box-solid">
                                <div class="box-header">
                                    <h3 class="box-title">Form Pembuatan Surat Keterangan Kehilangan KTP</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php echo form_input($tempat_kehilangan) ?>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Tanggal Kehilangan*</label>
                                                <?php echo form_input($tgl_kehilangan) ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            ...
            function checkFormatPhone() {
                jQuery.ajax({
                    url: "<?php echo base_url('sk_hilang_ktp/check_format_phone') ?>",
