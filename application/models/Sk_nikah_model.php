...
class Sk_nikah_model extends CI_Model
{
    ...
    function get_all_deleted()
    {
        ...
        $this->db->where('sk_nikah.is_delete', '1');
    ...
    {
        $this->db->join('status', 'sk_nikah.suami_status_id = status.id_status');
        $this->db->join('agama', 'sk_nikah.suami_agama_id = agama.id_agama');
