...
if (window.jQuery)(function ($) {
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		STRING: {
			remove: 'x',
			denied: 'Anda tidak dapat mengupload file berformat: "$ext" .\nSilahkan upload yang lain...',
			file: '$file',
			selected: 'File selected: $file',
			duplicate: 'File yang Anda pilih telah dipilih, silahkan upload yang lain:\n$file',
			toomuch: 'File-file yang anda pilih terlalu besar ($size)',
			toomany: 'Terlalu banyak file yang dipilih (max: $max)',
			toobig: 'Ukuran foto: $file terlalu besar (max $size)'
		},
